...
public:
    ...
    static size_t get_additionallength() 
    { 
        return Trans_Head_Length_ + Trans_Head_Additional_Length_; 
    }
    ...
    transaction(const transaction_head* phead, const char* pbody)
    {
        ...
        {
            memcpy(head_ptr_ + Trans_Head_Length_ + Trans_Head_Additional_Length_, 
                pbody, phead->body_length_);
        }
    }
    transaction(const transaction_head* phead, const transaction_additional* padditional, 
        const char* pbody)
    {
        int totallength = get_additionallength() + phead->body_length_;
        head_ptr_ = new char[totallength];
